...
namespace OpenRange.Physics
{
    ...
    public static class PhysicsConstants
    {
        ...
        #region Drag Coefficient Table (WSU Data)
        ...
        {
            new Vector2(0.375f, 0.450f),  // ~30 mph
            new Vector2(0.500f, 0.420f),  // ~40 mph
            new Vector2(0.625f, 0.390f),  // ~50 mph
            new Vector2(0.750f, 0.350f),  // ~60 mph
            new Vector2(0.875f, 0.300f),  // ~70 mph
            new Vector2(1.000f, 0.250f),  // ~80 mph
            new Vector2(1.250f, 0.230f),  // ~100 mph
            new Vector2(1.500f, 0.220f),  // ~120 mph
            new Vector2(2.000f, 0.210f),  // ~160 mph
        };
        
        /// <summary>Drag coefficient for supercritical flow (high speed)</summary>
        public const float CdSupercritical = 0.21f;
        
        #endregion
        
        #region Lift Coefficient Table (WSU Data)
        ...
        public const float ClMax = 0.181f;
